...
import { PenaltyGoalIcon, SportsIcon } from '@shared/icons';
        ...
        <CardBody>
          <div className="title">
            <div className="header">
              ...
              <Badge className="success2">
                <PenaltyGoalIcon width="15" className="me-1" />
                {i18n.label.penaltyGoal}
              </Badge>
            </div>
...
export default PenaltyGoalCard;
