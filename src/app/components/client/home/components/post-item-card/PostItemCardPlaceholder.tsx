...
function PostItemCardPlaceholder() {
  return (
    <Card className="post-item-card overflow-hidden">
      <ContentLoader
        width="500"
        height="185"
        viewBox="0 0 500 185"
      ...
      <CardBody>
        ...
        <ContentLoader
          ...
          height="18"
          viewBox="0 0 250 18"
          className="content-loader my-2"
        >
          <rect width="250" height="18" />
        </ContentLoader><br />
...
export default PostItemCardPlaceholder;
