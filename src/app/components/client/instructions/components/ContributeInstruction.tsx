...
import Step1 from '@assets/img/instructions/contribute/Step1.png';
import Step2 from '@assets/img/instructions/contribute/Step2.png';
import BackButton from '@shared/buttons/BackButton';
import useTranslation from '@shared/hooks/useTranslation';

function ContributeInstruction() {
        ...
        <Row className="mt-5 step">
          <Col>
            <div className="d-flex align-items-start gap-2">
              ...
              <div className="b3">{i18n.contribute.step1}</div>
            </div>
            <div className="mt-3">
        ...
        <Row className="mt-5 step">
          <Col>
            <div className="d-flex align-items-start gap-2">
              ...
              <div className="b3">{i18n.contribute.step2}</div>
            </div>
            <div className="mt-3">
...
export default ContributeInstruction;
